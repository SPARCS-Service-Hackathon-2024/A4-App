            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text('태그 선택', style: TextStyle(fontSize: 16)),
                    Wrap(
                    ...
                    TextField(
                      ...
                      maxLines: 10, // 제목 필드의 최대 라인을 1로 설정
                      keyboardType: TextInputType.multiline,
                    ),
                    SizedBox(height: 8.0), // 내용 필드와 사진 추가 버튼 사이의 간격
                    TextButton(
                      onPressed: () {
                        // 사진 추가 로직
                      },
            ...
            children: [
              Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: ['맛집', '공동구매', '정보', '질문', '모임', '나들이'].map((
                        tag) {
                      return Padding(
                        ...
                        child: FilterChip(
                          ...
                          labelStyle: TextStyle(
                            color: selectedTag == tag ? Colors.white : Colors
                                .black, // 선택 여부에 따른 라벨 색상 변경
                          ),
                                        ...
                                        Container(
                                          ...
                                          child: Chip(
                                            label: Text(tag, style: TextStyle(
                                                color: Colors.black)),
                                            // 텍스트 스타일 변경
                                            backgroundColor: Color(0xFFCBD7F7),
                                            // 배경색 변경
          ...
          Positioned(
            ...
            child: Center( // Center 위젯을 사용하여 수평 중앙 정렬
              child: Container(
                ...
                child: InkWell(
                    onTap: () => _showPostCreateDialog(context), // 익명 함수 사용 // 탭 이벤트 처리
                  child: Row(
